...
sections:
  ...
  - component: FeaturesBlock
    featureslist:
      - actions: []
        content: >-
          <div class="r-grid-item"><div class="r-card"><div class="r-card-head
          r-color-light-green"><div class="r-icon rc-icon-white"><img
          ...
          alt="" class="r-icon"></div></div><div class="r-card-body"><h4
          class="r-card-title">Node</h4><ul class="r-card-ul-hidden"><li><a
          class="rc-paragraph"
          href="/docs/deploy-node-express-app">Express</a></li><li><a
          class="rc-paragraph"
          href="/docs/deploy-node-hapi-app">hapi</a></li><li><a
          class="rc-paragraph"
          href="/docs/deploy-puppeteer-node">Puppeteer</a></li></ul></div></div></div>
        title: ''
      - actions:
          - label: View Posts
            url: blog/index.html
        content: >-
          <ul class="r-card-ul-hidden"><li><a class="rc-paragraph"
          href="/docs/deploy-redis">Redis</a></li><li><a class="rc-paragraph"
          href="/docs/deploy-elasticsearch">Elasticsearch</a></li><li><a
          class="rc-paragraph" href="/docs/deploy-mysql">MySQL</a></li></ul>
        title: Docker
      - actions:
          - label: Learn More
